package com.ruoyi.test_temp.controller;
 ...
 */
@RestController
@RequestMapping("/test_temp/test_temp")
public class TestTempController extends BaseController
{
     ...
     * 查询测试列表
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:list')")
    @GetMapping("/list")
     ...
     * 导出测试列表
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:export')")
     ...
     * 获取测试详细信息
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增测试
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:add')")
     ...
     * 修改测试
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:edit')")
     ...
     * 删除测试
     */
    @PreAuthorize("@ss.hasPermi('test_temp:test_temp:remove')")
